...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _bundles__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bundles */ \"./src/bundles/index.js\");\n/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./elements */ \"./src/elements/index.js\");\n\n\n\n\n\nconst findTack = {x: d=>{return d.x - 150/2}, y: d=>{return d.y - 10}}\nconst visualConfig = {\nstring:{\n\"stroke\":(d)=>d.color\n,\"stroke-width\":\"3px\"\n,\"fill\":\"none\"\n,\"stroke-linejoin\":\"round\"\n,\"stroke-linecap\":\"round\"\n},\nnoteBody:{\n    width: 150,\n    height: 150,\n    x: findTack.x,\n    y: findTack.y,\n    stroke:\"red\",\n    fill:\"dodgerblue\"\n}\n,\n}\n\n\nfunction draw(data, links){\n\n    // let noteConfig = {\n    //     noteBody:{\n    //         width: 150,\n    //         height: 150,\n    //         x: d=>{return d.x - 150/2},\n    //         y: d=>{return d.y - 10},\n    //         stroke:\"red\",\n    //         fill:\"dodgerblue\"\n    //     }\n    // }\n\n    Object(_elements__WEBPACK_IMPORTED_MODULE_1__[\"applyDataToNoteGroup\"])(\n        noteGroup\n        ,data\n        ,visualConfig\n    );\n\n    Object(_elements__WEBPACK_IMPORTED_MODULE_1__[\"applyDataToStringGroup\"])(\n        stringGroup\n        ,mapLinks(links, data)\n        ,visualConfig\n    );\n  Object(_elements__WEBPACK_IMPORTED_MODULE_1__[\"applyDataToTackGroup\"])(tackGroup, data);\n\n  tackGroup.selectAll(\"g\").call(drag)\n}\n\n/**\n    map links between data points based off of links array\n*/\nfunction mapLinks(links, data){\n  return links.map(link=>{\n    let start = data.find(datum=>{return datum.id == link[0]})\n    let end = data.find(datum=>{return datum.id == link[1]})\n    return {start:start, end:end, color: link[2] || \"red\"}\n  })\n}\n\n/**\n  apply multiple attrs from an array of arrays, lispy stylez\n*/\nfunction attrs(selection, ...attrs){\n  if(selection){\n  attrs.forEach(attr=>{\n    selection.attr(attr[0], attr[1])\n  })\n  return selection;\n }\n}\n\n/**\n  apply same-name properties from a config object to a d3 selection\n*/\nfunction samesies(selection, configObject){\n\n  for(var x in configObject){\n      // console.log(x);\n    selection.attr(x, configObject[x])\n  }\n  return selection;\n}\n\n/**\n  initiate drag\n*/\nfunction dragstarted(d) {\n    console.log(d)\n    _bundles__WEBPACK_IMPORTED_MODULE_0__[\"d3\"].select(this).selectAll(\"circle\").classed('moving', true);\n    _bundles__WEBPACK_IMPORTED_MODULE_0__[\"d3\"].select(\"#noteBody\"+d.id).classed(\"moving\", true);\n}\n\n/**\n  handle drag event\n*/\nfunction dragged(d) {\n    d.x = _bundles__WEBPACK_IMPORTED_MODULE_0__[\"d3\"].event.x\n    d.y = _bundles__WEBPACK_IMPORTED_MODULE_0__[\"d3\"].event.y\n    let moving = _bundles__WEBPACK_IMPORTED_MODULE_0__[\"d3\"].selectAll(\".moving\")\n               .attrs(\n                [\"cx\",d=>d.x]\n                ,[\"cy\",d=>d.y]\n                 ,[\"x\",findTack.x]\n                 ,[\"y\",findTack.y]\n               )\n    stringGroup.selectAll('path').attr('d', _elements__WEBPACK_IMPORTED_MODULE_1__[\"straightLine\"]);\n}\n/**\n    end drag procession\n*/\nfunction dragended(d) {\n    _bundles__WEBPACK_IMPORTED_MODULE_0__[\"d3\"].select(this).selectAll(\"circle\").classed('moving', false);\n}\n\nfunction init(svg){\n  svg\n    .attrs(\n      [\"width\", window.innerWidth]\n     ,[\"height\", window.innerHeight])\nlet g = svg.append(\"g\")\n    .attrs(\n      [\"width\", window.innerWidth]\n     ,[\"height\", window.innerHeight])\n    stringGroup = g.append(\"g\").attr(\"id\",\"strings\")\n    noteGroup = g.append(\"g\").attr(\"id\",\"notes\")\n    tackGroup = g.append(\"g\").attr(\"id\",\"tacks\")\n\n    svg.call(_bundles__WEBPACK_IMPORTED_MODULE_0__[\"d3\"].zoom().scaleExtent([1 / 2, 4])\n        .on(\"zoom\", e=>{\n            g.attr(\"transform\",_bundles__WEBPACK_IMPORTED_MODULE_0__[\"d3\"].event.transform)\n            _bundles__WEBPACK_IMPORTED_MODULE_0__[\"d3\"].select(\"#showZoom\").text(_bundles__WEBPACK_IMPORTED_MODULE_0__[\"d3\"].event.transform.k)\n        }))\n\n    // let zoom = d3.zoom();\n}\n\nfunction setupDemo(){\n  init(_bundles__WEBPACK_IMPORTED_MODULE_0__[\"d3\"].select(\"body\").append(\"svg\"));\n  draw(data,links);\n}\n\n\nwindow.setupDemo = setupDemo;\n\n\nlet data = [{id:1,x:100, y:200}\n            , {id:2,x:300, y:200}\n           , {id:3,x:200, y:300}\n           ,{id:4, x:400, y:100}];\n\nlet links = [[1,2, \"green\"],\n            [1,3, \"blue\"],\n            [2,3],\n            [4,2,\"gray\"]]\n\nlet svg,\ntackGroup,\nstringGroup,\nnoteGroup\n\n\n\n\nlet drag = _bundles__WEBPACK_IMPORTED_MODULE_0__[\"d3\"].drag()\n        .on('start', dragstarted)\n        .on('drag', dragged)\n        .on('end', dragended);\n\nlet line = _bundles__WEBPACK_IMPORTED_MODULE_0__[\"d3\"].line()\n  .x(d=>d.x)\n  .y(d=>d.y)\n\n\n//# sourceURL=webpack:///./src/app.js?");
